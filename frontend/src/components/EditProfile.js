...
const EditProfile = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.post(`http://localhost:3001/api/user/edit-profile`,
                formData,
                {
                ...
                <div className="grid grid-cols-8 pt-3 sm:grid-cols-10">
                    ...
                    <div className="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
                        ...
                        <div className="flex items-center mb-8">
                            ...
                            <button className="mt-5 ml-2 h-6  cursor-pointer text-sm font-semibold text-gray-600 underline decoration-2">Show Password</button>
                        </div>
                        <p className="mt-2">Can't remember your current password? <a className="text-sm font-semibold text-blue-600 underline decoration-2" href="/reset-password">Reset Password</a></p>
